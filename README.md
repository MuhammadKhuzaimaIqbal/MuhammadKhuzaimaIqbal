...
- **[RecitAI – Award-Winning Intelligent Quranic Learning Application (FYP)](https://recite-ai.netlify.app/)** – AI-powered Quranic recitation learning platform built with Flutter, MERN, PyTorch, and OpenAI Whisper. Developed a custom Quranic speech dataset with **13K+ recordings and 101K+ training samples**, fine-tuned Whisper for Quranic Arabic recognition, and deployed optimized on-device inference using **whisper.cpp, C/C++ FFI, and quantization** for fully offline real-time feedback.  **1st Place – Spark Up Innovation Summit 2026, ITU Lahore**g
